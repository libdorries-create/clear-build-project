...
class HardenedValidatorApp:
    ...
    def validate_philosophy(self):
        ...
        try:
            ...
            plt.style.use('dark_background')
            plt.barh(list(self.percentages.keys()), list(self.percentages.values()), color='#00bcff', edgecolor='white')
    ...
    def validate_economics(self):
        ...
        try:
            ...
            plt.style.use('dark_background')
            plt.pie(list(self.econ_percentages.values()), labels=list(self.econ_percentages.keys()), autopct='%1.1f%%', colors=['#ffaa00', '#00ff66', '#f43f5e'], startangle=140)
            plt.title("Macroeconomic Cycle Fit Breakdown")
            plt.tight_layout()
